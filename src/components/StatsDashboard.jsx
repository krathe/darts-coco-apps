...
export default function StatsDashboard({ onBack }) {
  ...
  const processStats = (data) => {
    if (data.length === 0) {
      setStats({ games: 0, avg: 0, bestAvg: 0, total180: 0, bestLeg: 0, best301: 0, best501: 0, checkoutRate: 0, scoringDistribution: [], totalDartsThrown: 0, highestCheckout: 0, recentAvg: 0, avgTrend: 0, winRate: 0 });
    ...
    setStats({ games, avg, bestAvg, total180, bestLeg: 0, best301, best501, checkoutRate, scoringDistribution: scoringData, totalDartsThrown, highestCheckout, recentAvg, avgTrend, winRate });
                    ...
                    <div className="flex items-center justify-between mb-4 relative z-10">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                {/* Affichage Win Rate si filtré par joueur */}
                                {selectedPlayer !== 'ALL' && (
